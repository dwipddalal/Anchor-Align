...
OXE_DATASET_CONFIGS = {
    ...
    "default_task": {
        "image_obs_keys": {"primary": "cam_high", "secondary": None, "wrist": "cam_wrist"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT,
        "action_encoding": ActionEncoding.JOINT_POS,
    },
    ### Real-world xArm7 clutter dataset (multi-task: pineapple / red bell pepper / yellow bell pepper)
    ### Same hardware/format as default_task; only differs in NUM_ACTIONS_CHUNK (64 vs 8) — see constants.py
    "clutter_task": {
        "image_obs_keys": {"primary": "cam_high", "secondary": None, "wrist": "cam_wrist"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
